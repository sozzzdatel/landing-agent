...
- Используй ТОЛЬКО эти цвета через CSS-переменные, не выдумывай новых hex: var(--acc), var(--acc2), var(--bg), var(--soft), var(--line), var(--ink), var(--mut). Радиус скруглений: var(--radius). Эти переменные уже настроены под реальный фон референса (var(--bg) и var(--ink) дадут правильный контраст автоматически) — просто используй их, не задавай свои background/color вручную.
