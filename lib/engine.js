...
const BRANDS = {
  studyai:{name:'StudyAI',domain:'study24.ai',logo:'StudyAI',vars:{acc:'#0A7CFF',acc2:'#6FB4FF',ink:'#0c1526',bg:'#fff',soft:'#eaf3ff',line:'#d6e6fb',mut:'#5a6a85',heroBg:'linear-gradient(135deg,#e6f1ff,#f3f8ff)',heroInk:'#0a1b33',display:"'Manrope',sans-serif",body:"'Inter',sans-serif",radius:'16px'}},
  kampus:{name:'Кэмп',domain:'kampslides.ru',logo:'Кэмп',vars:{acc:'#4F46E5',acc2:'#9B95F0',ink:'#12122a',bg:'#fff',soft:'#eeecfc',line:'#e0ddf7',mut:'#5a5a7a',heroBg:'linear-gradient(135deg,#eae7fc,#f5f3ff)',heroInk:'#17143a',display:"'Manrope',sans-serif",body:"'Inter',sans-serif",radius:'14px'}},
  avtor24:{name:'Автор24',domain:'avtor24.ru',logo:'Автор24',vars:{acc:'#7C3AED',acc2:'#FFD23F',ink:'#170e2b',bg:'#fff',soft:'#f3edfd',line:'#e7dcfa',mut:'#5f5478',heroBg:'linear-gradient(135deg,#f0e8fd,#fdfbe9)',heroInk:'#231145',display:"'Manrope',sans-serif",body:"'Inter',sans-serif",radius:'12px'}},
  mystylus:{name:'MyStylus',domain:'mystylus.ai',logo:'MyStylus',vars:{acc:'#111111',acc2:'#FFD400',ink:'#0a0a0a',bg:'#fff',soft:'#f5f5f5',line:'#e6e6e6',mut:'#666666',heroBg:'linear-gradient(135deg,#fafafa,#fffdf0)',heroInk:'#0a0a0a',display:"'Fraunces',serif",body:"'Inter',sans-serif",radius:'20px'}},
  studybay:{name:'StudyBay',domain:'studybay.com',logo:'StudyBay',vars:{acc:'#16A34A',acc2:'#6EE7B7',ink:'#0c1a14',bg:'#fff',soft:'#e9f8f1',line:'#d6efe4',mut:'#4d6a5c',heroBg:'linear-gradient(135deg,#e2f7ee,#f1fbf7)',heroInk:'#0c2a1e',display:"'Manrope',sans-serif",body:"'Inter',sans-serif",radius:'12px'}}
};
